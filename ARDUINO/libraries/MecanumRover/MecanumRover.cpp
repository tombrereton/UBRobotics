...
void MecanumRover::adjustSpeed(){ //Change the speed of the 4 wheels according to the average rotational displacement of all 4 wheels
  ...
  */
  ...
  for (int i = 0; i < 4; i ++){
    if ((counter[i] > 200) &&(sensorStop == false)){ //To make sure all wheels start up at the same speed avoid correction until a certain displacement, and that the sensor is not detecting anything
